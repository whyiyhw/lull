...
- **调频拨盘 · 电台频道**（F-4）：复古 FM 拨盘（87.5–108 MHz），7 个内置频道固定刻度（88.1 雨夜 / 90.4 晨林 / 92.9 海边 / 95.6 炉边 / 98.3 车厢 / 100.9 深空 / 103.1 雨眠·助眠），一键交叉淡化切换；拖动扫台有白噪嘶声 + 雪花反馈、松手吸附；可把当前混音「存为频道」（可拖动改频率、**长按删除**，上限 8）。`role=slider` 方向键可达。
